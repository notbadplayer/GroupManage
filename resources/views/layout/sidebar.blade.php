    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @can('admin-level')
            <li class="nav-item">
                ...
                <ul id="users-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li> <a href="{{ route('users.index') }}"> <i class="fa-regular fa-circle"></i><span>Lista użytkowników</span>
                        </a></li>
                    <li> <a href="{{ route('users.create') }}"> <i class="fa-regular fa-circle"></i><span>Dodaj użytkownika</span>
                        </a></li>
                </ul>
            </li>
            <li class="nav-item">
                ...
                <ul id="groups-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li> <a href="{{ route('groups.index') }}"> <i class="fa-regular fa-circle"></i><span>Lista grup</span> </a>
                    </li>
                    <li> <a href="{{ route('groups.create') }}"> <i class="fa-regular fa-circle"></i><span>Dodaj grupę</span> </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
                ...
                <ul id="publications-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li> <a href="{{ route('publications.index') }}"> <i class="fa-regular fa-circle"></i><span>Lista
                                Ogłoszeń</span> </a></li>
                    <li> <a href="{{ route('publications.create') }}"> <i class="fa-regular fa-circle"></i><span>Dodaj
        ...
        <li class="nav-item">
            ...
            <ul id="notes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li> <a href="{{ route('notes.index') }}"> <i class="fa-regular fa-circle"></i><span>Lista nut</span> </a></li>
                @can('admin-level')
                    <li> <a href="{{ route('notes.create') }}"> <i class="fa-regular fa-circle"></i><span>Dodaj nuty</span> </a>
                    </li>
        ...
        <li class="nav-item">
            ...
            <ul id="player-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li> <a href="{{ route('songs.index') }}"> <i class="fa-regular fa-circle"></i><span>Lista utworów</span> </a>
                </li>
                @can('admin-level')
                    <li> <a href="{{ route('songs.create') }}"> <i class="fa-regular fa-circle"></i><span>Dodaj utwór</span> </a>
                    </li>
                    <li> <a href="{{ route('categories.index') }}"> <i class="fa-regular fa-circle"></i><span>Kategorie</span> </a>
                    </li>
                @endcan
        ...
        @can('admin-level')
            <li class="nav-item">
                ...
                <ul id="events-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li> <a href="{{ route('events.index') }}"> <i class="fa-regular fa-circle"></i><span>Lista wydarzeń</span>
                        </a></li>
                    <li> <a href="{{ route('events.create') }}"> <i class="fa-regular fa-circle"></i><span>Dodaj wydarzenie</span>
                        </a></li>
                </ul>
            </li>
        @endcan
