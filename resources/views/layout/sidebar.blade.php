<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
       ...
       <li class="nav-item">
          <a class="nav-link collapsed" data-bs-target="#player-nav" data-bs-toggle="collapse" href="#"> <i class="fa-solid fa-circle-play"></i><span>Odtwarzacz</span><i class="bi bi-chevron-down ms-auto"></i> </a>
          <ul id="player-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
             <li> <a href="{{ route('songs.index') }}"> <i class="bi bi-circle"></i><span>Lista utworów</span> </a></li>
             <li> <a href="{{ route('songs.create') }}"> <i class="bi bi-circle"></i><span>Dodaj utwór</span> </a></li>
             <li> <a href="{{ route('categories.index') }}"> <i class="bi bi-circle"></i><span>Kategorie</span> </a></li>
          </ul>
       </li>
       <li class="nav-item">
          <a class="nav-link collapsed" data-bs-target="#events-nav" data-bs-toggle="collapse" href="#"> <i class="fa-solid fa-calendar-days"></i><span>Wydarzenia</span><i class="bi bi-chevron-down ms-auto"></i> </a>
          <ul id="events-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li> <a href="{{ route('events.index') }}"> <i class="bi bi-circle"></i><span>Lista wydarzeń</span> </a></li>
            <li> <a href="{{ route('events.create') }}"> <i class="bi bi-circle"></i><span>Dodaj wydarzenie</span> </a></li>
          </ul>
       </li>
